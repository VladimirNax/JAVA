package skillfactory;//package skillfactory;
...
public class BankAccount {
    ...
    /**
     * Аккаунт со всеми полями. Можно создать другие, но смотрите чтобы в skillfactory.BankService позже не было проблем
